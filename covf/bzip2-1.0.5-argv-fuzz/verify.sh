...
function run () {
  ...
  case ${seed_num} in 
    0) 
      cp ${home_folder}/train_input_copy/trainc/sample1.ref ${home_folder}/train_input/trainc/sample.ref
      run_script="< $input >sample1.rb2"
      ;;    
    1)
      cp ${home_folder}/train_input_copy/traink/foo ${home_folder}/train_input/traink/foo
      ;;
    2) 
      cp ${home_folder}/train_input_copy/traint/foo ${home_folder}/train_input/traint/foo
      ;;  
    3) 
      cp ${home_folder}/train_input_copy/traint/sample1.bz2.ref ${home_folder}/train_input/traint/sample1.bz2.ref
      ;;
    4) 
      cp ${home_folder}/train_input_copy/traind/sample1.bz2.ref ${home_folder}/train_input/traind/sample1.bz2.ref
