...
function run () {
  ...
  run_script="$input"
  case ${seed_num} in 
    0) # -c <references/sample1.ref >sample1.rb2
      run_script="-c < $input >sample1.rb2"
      ;;    
    1) # -d <references/sample1.bz2.ref >sample1.tst; 
      run_script="-d < $input >sample1.tst"
      ;;   
    2) # -f foo
      run_script="-f $input"
      ;;   
    3) # -t foo
      run_script="-t $input"
      ;;   
    4) # -t references/sample1.bz2.ref
      run_script="-t $input"
      ;;   
    5) # -k foo
      run_script="-k $input"
