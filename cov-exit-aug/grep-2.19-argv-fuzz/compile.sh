...
then 
    ...
    afl-clang-fast -w ./${program_name}.c.${test_type}.c  -D "__msan_unpoison(s,z)" -lpcre -o $bin
else 
    # for radamsa
    ...
    clang $CFLAGS -g -w ./${program_name}.c.${test_type}.c -D "__msan_unpoison(s,z)" -lpcre -o $bin
fi
